...
DATASETS = [
    ...
    ("FD002", "C-MAPSS FD002", PROJECT_ROOT / "data/processed/outputs/FD002/fd002_decision_support.csv", "v1"),
    ("FD003", "C-MAPSS FD003", PROJECT_ROOT / "data/processed/outputs/FD003/fd003_decision_support.csv", "v1"),
    ("FD004", "C-MAPSS FD004", PROJECT_ROOT / "data/processed/outputs/FD004/fd004_decision_support.csv", "v1"),
