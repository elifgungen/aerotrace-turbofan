...
def run_cmapss_adapter(
    ...
    if out_csv is None:
        stem = Path(rul_csv).stem.replace("_rul_predictions", "")
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run v2 decision support adapter for C-MAPSS")
