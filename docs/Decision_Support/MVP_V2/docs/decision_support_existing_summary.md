...
Kaynaklar:
- `docs/Decision_Support/C-MAPSS/decision_logic.md`
- `demo/decision_support_runner.py`
- `docs/Decision_Support/C-MAPSS/data/outputs/fd001_decision_support.csv`
- `docs/Decision_Support/C-MAPSS/data/outputs/fd002_decision_support.csv`
...
Not: `demo/decision_support_runner.py` içinde V2 için `theta_warn/theta_critical` ve `alpha_warn/alpha_critical` da var; ancak V1 CSV’de tek eşik çifti (`theta_rul_used`, `alpha_anomaly_used`) raporlanıyor.
