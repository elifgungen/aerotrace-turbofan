...
- Notebook DATASETS yalnızca BASE/A/B içerir ve repo-relative: `notebooks/RUL/FD004/FD004_compare_BASE_A_B_OzcanMetrics_CAP125.ipynb:111`

### 2) HIGH — Hard-coded Windows path kaldırıldı (repo-relative)
- Notebook’ta A/B path’leri artık repo-relative: `notebooks/RUL/FD004/FD004_compare_BASE_A_B_OzcanMetrics_CAP125.ipynb:119`
- Windows path kalmadı (ör. `C:\\Havelsan\\...`): `notebooks/RUL/FD004/FD004_compare_BASE_A_B_OzcanMetrics_CAP125.ipynb:119`
...
- Notebook OOF’da clone kullanır: `notebooks/RUL/FD004/FD004_compare_BASE_A_B_OzcanMetrics_CAP125.ipynb:379`
...
1) A/B varyant üret (default BASE input path’leri ile):
   - Komut:
     - `python scripts/build_fd004_variants.py --base-train-csv data/processed/CMAPSS_full_norm/FD004/FD004_full_global_zscore/train_FD004_full_global_zscore_nodrop.csv --base-test-csv data/processed/CMAPSS_full_norm/FD004/FD004_full_global_zscore/test_FD004_full_global_zscore_nodrop.csv --out-dir data/processed/CMAPSS_full_norm/FD004/_generated_variants --k 6 --seed 42 --ddof 1`
   - Beklenen çıktılar:
     - `data/processed/CMAPSS_full_norm/FD004/_generated_variants/build_report.json`
     - `data/processed/CMAPSS_full_norm/FD004/_generated_variants/A_global_zscore_regime_onehot_k6/train_FD004_global_zscore_regime_onehot_k6.csv`
     - `data/processed/CMAPSS_full_norm/FD004/_generated_variants/A_global_zscore_regime_onehot_k6/test_FD004_global_zscore_regime_onehot_k6.csv`
     - `data/processed/CMAPSS_full_norm/FD004/_generated_variants/A_global_zscore_regime_onehot_k6/fd004_regime_k6_model.json`
     - `data/processed/CMAPSS_full_norm/FD004/_generated_variants/B_regimeaware_sensor_zscore_k6_onehot/train_FD004_regimeaware_sensor_zscore_k6_onehot.csv`
     - `data/processed/CMAPSS_full_norm/FD004/_generated_variants/B_regimeaware_sensor_zscore_k6_onehot/test_FD004_regimeaware_sensor_zscore_k6_onehot.csv`
     - `data/processed/CMAPSS_full_norm/FD004/_generated_variants/B_regimeaware_sensor_zscore_k6_onehot/fd004_regimeaware_sensor_scaler_k6.json`

2) Train/eval (BASE/A/B; leakage-safe OOF stacking):
   - Komut:
     - `python scripts/train_fd004_variants.py --cap 125 --tau 15 --seed 42 --stacking-folds 5 --out-dir outputs/fd004 --base-train-csv data/processed/CMAPSS_full_norm/FD004/FD004_full_global_zscore/train_FD004_full_global_zscore_nodrop.csv --base-test-csv data/processed/CMAPSS_full_norm/FD004/FD004_full_global_zscore/test_FD004_full_global_zscore_nodrop.csv --a-train-csv data/processed/CMAPSS_full_norm/FD004/_generated_variants/A_global_zscore_regime_onehot_k6/train_FD004_global_zscore_regime_onehot_k6.csv --a-test-csv data/processed/CMAPSS_full_norm/FD004/_generated_variants/A_global_zscore_regime_onehot_k6/test_FD004_global_zscore_regime_onehot_k6.csv --b-train-csv data/processed/CMAPSS_full_norm/FD004/_generated_variants/B_regimeaware_sensor_zscore_k6_onehot/train_FD004_regimeaware_sensor_zscore_k6_onehot.csv --b-test-csv data/processed/CMAPSS_full_norm/FD004/_generated_variants/B_regimeaware_sensor_zscore_k6_onehot/test_FD004_regimeaware_sensor_zscore_k6_onehot.csv`
   - Beklenen çıktılar:
...
- `python scripts/run_fd004.py --cap 125 --tau 15 --seed 42 --k 6 --ddof 1 --stacking-folds 5 --variants-out-dir data/processed/CMAPSS_full_norm/FD004/_generated_variants --out-dir outputs/fd004`

## Beklenen artefact’lar (çalıştırma sonrası)
- Variant build: `data/processed/CMAPSS_full_norm/FD004/_generated_variants/build_report.json`: `scripts/build_fd004_variants.py:219`
