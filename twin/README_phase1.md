...
```powershell
.\.venv\Scripts\python.exe 04_twin/scripts/build_twin_inputs_ncmapss.py --datasets DS01 DS02 DS03 DS04 DS05 DS06 DS07
```

Uretim:
- `04_twin/inputs/ncmapss_DSxx_twin_feed.csv`
- `04_twin/inputs/ncmapss_twin_input_audit.json`

## 3) Replay runtime calistirma

```powershell
.\.venv\Scripts\python.exe 04_twin/scripts/run_twin_phase1_replay.py --datasets DS01 DS02 DS03 DS04 DS05 DS06 DS07
```

Uretim:
- `04_twin/outputs/DSxx/state_timeline.csv`
- `04_twin/outputs/DSxx/events.csv`
- `04_twin/outputs/DSxx/summary.json`
- `04_twin/outputs/phase1_summary.csv`

## 4) UI

```powershell
.\.venv\Scripts\python.exe -m streamlit run 04_twin/app/streamlit_twin_phase1.py
```
...
- `04_twin/config/phase1_policy.yaml`
