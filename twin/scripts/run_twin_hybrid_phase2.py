...
Input:
- twin/data/decision_support_v2_outputs/ncmapss_DSxx_decision_support_v2.csv
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--policy-root", default="twin/data/decision_support_v2_outputs")
    parser.add_argument("--out-root", default="twin/data/hybrid_phase2")
    parser.add_argument("--config", default="twin/config/hybrid_phase2_policy.json")
