...
- `AeroTrace/OUTPUTS/ncmapss_DS01_decision_support.csv` (v1)
- `AeroTrace/OUTPUTS/ncmapss_DS01_decision_support_v2.csv` (v2)
- `AeroTrace/OUTPUTS/audit/delta_ncmapss_ds01.csv`
- `AeroTrace/OUTPUTS/audit/hardening_diagnostics.json`
- Yardımcı tablolar:
  - `AeroTrace/OUTPUTS/audit/ds01_transition_matrix.csv`
  - `AeroTrace/OUTPUTS/audit/ds01_split_change_ratio.csv`
