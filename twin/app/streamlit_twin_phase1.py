...
RUL_ROOT = Path("notebooks/RUL/N-CMAPSS")
PROCESSED_NCMAPSS_ROOT = Path("data/processed/N-CMAPSS")
...
def resolve_shap_paths(dataset: str) -> Optional[Dict[str, Path]]:
    ...
    pred_candidates = [
        ...
        RUL_ROOT / ds / f"ncmapss_{ds}_rul_predictions_autogluon.csv",
    ]
    ...
    artifact_candidates = [
        RUL_ROOT / ds / "autogluon_artifacts",
    ]
