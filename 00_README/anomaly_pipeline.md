...
- `01_data/processed/train_FD003_full_norm.csv`
- `01_data/processed/test_FD003_full_norm.csv`
- `01_data/processed/train_FD004_full_norm.csv`
- `01_data/processed/test_FD004_full_norm.csv`
...
### FD003
```bash
python scripts/anomaly_baseline_deviation.py --dataset FD003 --train_csv 01_data/processed/train_FD003_full_norm.csv --test_csv 01_data/processed/test_FD003_full_norm.csv --config configs/anomaly_thresholds.json --outdir data/outputs
python scripts/validate_anomaly_artifacts.py --dataset FD003 --train_csv 01_data/processed/train_FD003_full_norm.csv --test_csv 01_data/processed/test_FD003_full_norm.csv --scores_csv data/outputs/fd003_anomaly_scores.csv --report_json data/outputs/fd003_anomaly_report.json --mapping_json data/outputs/fd003_anomaly_mapping_params.json
```
...
### FD004
```bash
python scripts/anomaly_baseline_deviation.py --dataset FD004 --train_csv 01_data/processed/train_FD004_full_norm.csv --test_csv 01_data/processed/test_FD004_full_norm.csv --config configs/anomaly_thresholds.json --outdir data/outputs
python scripts/validate_anomaly_artifacts.py --dataset FD004 --train_csv 01_data/processed/train_FD004_full_norm.csv --test_csv 01_data/processed/test_FD004_full_norm.csv --scores_csv data/outputs/fd004_anomaly_scores.csv --report_json data/outputs/fd004_anomaly_report.json --mapping_json data/outputs/fd004_anomaly_mapping_params.json
```
