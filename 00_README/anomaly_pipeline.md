...
- `01_data/processed/.../train_FD00x_*.csv`
- `01_data/processed/.../test_FD00x_*.csv`
...
python scripts/anomaly_baseline_deviation.py \
  --dataset FD001 \
  --train_csv 01_data/processed/.../train_FD001_*.csv \
  --test_csv 01_data/processed/.../test_FD001_*.csv \
...
### Input Gereksinimleri
```
02_notebooks_exports/Anomaly/N-CMAPSS/data/DS0x/
├── train_DS0x_v0.csv
├── test_DS0x_v0.csv
├── scaler_DS0x_v0.json
└── manifest.json
...
```bash
python 02_notebooks_exports/Anomaly/N-CMAPSS/scripts/compute_anomaly_ncmapss.py
```

### Çıktılar
```
02_notebooks_exports/Anomaly/N-CMAPSS/OUTPUTS/
