...
```
AeroTrace/
├── 00_README/                    # Proje dokümantasyonu
│   ├── README.md                 # Bu dosya
...
│
├── 03_docs/                      # Teknik raporlar ve analiz dokümanları
...
│
├── 04_figures/                   # Analiz görselleri
│
├── 05_demo/                      # Demo ve karar destek pipeline
...
│
├── 08_twin/                      # 3D Digital Twin (Streamlit versiyonu)
│   ├── app/                      # Streamlit uygulaması
│   ├── config/                   # Twin konfigürasyonları
│   └── data/                     # Twin veri dosyaları
│
└── 09_webapp/                    # ★ Ana web uygulaması (Vite + Vanilla JS)
