...
- FD001: `05_demo/demo output/fd001_decision_support_baseline_deviation.csv`
- FD002: `05_demo/demo output/fd002_decision_support_with_anomaly.csv`
...
- `05_demo/plot_decision_support_examples.py`

**Sentetik/smoke test yardımcıları:**
- `05_demo/simulate_anomaly_scores.py`
- `05_demo/smoke_test_decision_support_synthetic.py`

**Karar mantığı dokümanı (spec):**
- `03_docs/Decision_Support/decision_logic.md`
...
```bash
python 05_demo/decision_support_runner.py \
  --pred 02_notebooks_exports/RUL/FD002/FD002_Ozcan_All/fd002_test_predictions_FD002_LOCAL_REGIMEAWARE_SENSOR_ZSCORE_K6_ONEHOT.csv \
  --rul-col rul_pred \
  --anomaly 02_notebooks_exports/Anomaly/jet-cube-turbofan-mvp/outputs/anomaly/FD002/fd002_anomaly_test.csv \
  --out "05_demo/demo output/fd002_decision_support_with_anomaly.csv" \
  --emit-v1 "data/outputs/fd002_decision_support.csv" \
  --config "config/decision_support_thresholds.json" \
  --report-json "05_demo/demo output/fd002_decision_support_with_anomaly_report.json"
```

## 7) Kanıt Artefact’ları (Rapor + Plot)

**Runner raporları (eşikler + state dağılımı + kalibrasyon):**
- `05_demo/demo output/fd001_decision_support_baseline_deviation_report.json`
- `05_demo/demo output/fd002_decision_support_with_anomaly_report.json`

**Örnek timeline plot’lar (RUL + anomaly + state geçişleri):**
- `04_figures/decision_support/fd001_baseline_engine_73_timeline.png`
- `04_figures/decision_support/fd001_baseline_engine_49_timeline.png`
- `04_figures/decision_support/fd002_engine_1_timeline.png`
- `04_figures/decision_support/fd002_engine_159_timeline.png`

Plot üretme:
```bash
python 05_demo/plot_decision_support_examples.py \
  --ds "05_demo/demo output/fd001_decision_support_baseline_deviation.csv" \
  --pred "02_notebooks_exports/RUL/FD001/FD001_Ozcan_AllRaws/predictions_cycle_all_rows.csv" \
  --rul-col pred_ensemble \
  --anomaly "02_notebooks_exports/Anomaly/jet-cube-turbofan-mvp/outputs/fd001_anomaly_scores.csv" \
  --out-dir "04_figures/decision_support" \
...
- [x] Kanıt raporu mevcut (FD001/FD002 JSON): `05_demo/demo output/*_report.json`
- [x] Görsel kanıt mevcut (timeline PNG): `04_figures/decision_support/*.png`
