# Streamlit Demo Runbook — AeroTrace Decision Support (FD001–FD004)
...
```bash
streamlit run 05_demo/streamlit_dashboard/streamlit_app.py
```

## 3) Input gereksinimleri (canonical)

Uygulama varsayılan olarak şu dizinleri sırayla dener:
- `05_demo/data/outputs/`
- `05_demo/decision_support_v2_outputs/`
