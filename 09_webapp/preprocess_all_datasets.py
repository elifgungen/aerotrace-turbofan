...
DATASETS = [
    ...
    ("FD001", "C-MAPSS FD001", PROJECT_ROOT / "05_demo/decision_support_v2_outputs/fd001_decision_support_v2.csv", "v2_fd"),
    # C-MAPSS v1 (FD002-FD004)
    ("FD002", "C-MAPSS FD002", PROJECT_ROOT / "01_data/processed/outputs/FD002/fd002_decision_support.csv", "v1"),
    ("FD003", "C-MAPSS FD003", PROJECT_ROOT / "01_data/processed/outputs/FD003/fd003_decision_support.csv", "v1"),
    ("FD004", "C-MAPSS FD004", PROJECT_ROOT / "01_data/processed/outputs/FD004/fd004_decision_support.csv", "v1"),
    # N-CMAPSS v2 (DS01-DS07)
    ("DS01", "N-CMAPSS DS01", PROJECT_ROOT / "05_demo/decision_support_v2_outputs/ncmapss_DS01_decision_support_v2.csv", "v2_ncmapss"),
    ("DS02", "N-CMAPSS DS02", PROJECT_ROOT / "05_demo/decision_support_v2_outputs/ncmapss_DS02_decision_support_v2.csv", "v2_ncmapss"),
    ("DS03", "N-CMAPSS DS03", PROJECT_ROOT / "05_demo/decision_support_v2_outputs/ncmapss_DS03_decision_support_v2.csv", "v2_ncmapss"),
    ("DS04", "N-CMAPSS DS04", PROJECT_ROOT / "05_demo/decision_support_v2_outputs/ncmapss_DS04_decision_support_v2.csv", "v2_ncmapss"),
    ("DS05", "N-CMAPSS DS05", PROJECT_ROOT / "05_demo/decision_support_v2_outputs/ncmapss_DS05_decision_support_v2.csv", "v2_ncmapss"),
    ("DS06", "N-CMAPSS DS06", PROJECT_ROOT / "05_demo/decision_support_v2_outputs/ncmapss_DS06_decision_support_v2.csv", "v2_ncmapss"),
    ("DS07", "N-CMAPSS DS07", PROJECT_ROOT / "05_demo/decision_support_v2_outputs/ncmapss_DS07_decision_support_v2.csv", "v2_ncmapss"),
]
